 ...
 * @author Equipo
 */
public class AdminCiudades extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblBuscar3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 80, -1));
        ...
        lblBuscar4.setText("Ciudad");
        lblBuscar4.setToolTipText("");
        jPanel1.add(lblBuscar4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 80, -1));
        ...
        jPanel1.add(panelTxtBuscar4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 110, 210, 22));

        jComboBox1.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 210, 22));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminCiudades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminCiudades().setVisible(true);
            }
        });
    }
